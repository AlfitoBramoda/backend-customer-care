...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('division', [
      ...
      { division_id: 6, division_code: 'UIC3', division_name: 'DGO USER 1', created_at: new Date(), updated_at: new Date() }, 
      { division_id: 7, division_code: 'UIC6', division_name: 'DGO USER 1', created_at: new Date(), updated_at: new Date() }, 
      { division_id: 8, division_code: 'UIC7', division_name: 'DGO USER 1', created_at: new Date(), updated_at: new Date() }, 
      { division_id: 9, division_code: 'UIC8', division_name: 'DGO USER 1', created_at: new Date(), updated_at: new Date() }, 
      { division_id: 10, division_code: 'UIC10', division_name: 'DGO USER 1', created_at: new Date(), updated_at: new Date() }
    ],{});
  },
